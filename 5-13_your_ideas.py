...
# files in this directory to sub-directories based on suffices. so files 5* all go
# into a folder called Chapter-5. etc
#
# i want to create databases, read, delete, and updata data in them as well. 
#
